class BinaryNode<T>
{
   ...
   public void postorderTraverse_binaryNodeMethod(BinaryNode<T> root)
   {
      if(root == null){
         return;
      }
      postorderTraverse_binaryNodeMethod(root.leftChild);
      postorderTraverse_binaryNodeMethod(root.rightChild);
   ...
   {  
      ...
      return 1+getHeight_binaryNodeMethod(node.leftChild)+ getHeight_binaryNodeMethod(node.rightChild);
